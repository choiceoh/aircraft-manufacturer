...
(function (root) {
  ...
  const AIRLINES = [
    { id: 'hanul', enginePref: 'P&W', name: '대한항공', home: '동아시아', bias: 'narrow', priceSensitivity: 0.9, prestige: 0.8,
      ...
      hub: 'seoul', startFleet: { 'a321': 5, 'b737-400': 4 },
      startSlots: { seoul: 24, tokyo: 8, osaka: 5, beijing: 5, hongkong: 4 }, },
    { id: 'carta', enginePref: 'GE', name: '에미레이트 항공', home: '중동', bias: 'wide', priceSensitivity: 0.5, prestige: 1.25,
      ...
      hub: 'dubai', startFleet: { 'b777-200er': 3, 'a310-300': 3 },
      startSlots: { dubai: 26, london: 6, delhi: 6, cairo: 5, istanbul: 5 }, },
    { id: 'nordic', enginePref: 'P&W 캐나다', name: '비데뢰에', home: '북유럽', bias: 'regional', priceSensitivity: 1.15, prestige: 0.7,
      ...
      hub: 'stockholm', startFleet: { 'atr72-500': 5, 'rj85': 3 },
      startSlots: { stockholm: 20, london: 5, frankfurt: 4, moscow: 4, amsterdam: 4 }, },
    { id: 'panamer', enginePref: 'P&W', name: '델타 항공', home: '북미', bias: 'narrow', priceSensitivity: 1.05, prestige: 1.0,
      ...
      hub: 'newyork', startFleet: { 'b757-200': 5, 'b737-400': 5 },
      startSlots: { newyork: 28, chicago: 12, losangeles: 8, miami: 6, dallas: 6 }, },
    { id: 'asialink', enginePref: '롤스로이스', name: '세부퍼시픽', home: '동남아', bias: 'wide', priceSensitivity: 1.2, prestige: 0.85,
      ...
      hub: 'manila', startFleet: { 'a330-300': 3, 'a320': 4 },
      startSlots: { manila: 22, hongkong: 8, singapore: 6, taipei: 5, tokyo: 4 }, },
    { id: 'albion', enginePref: '롤스로이스', name: '영국항공', home: '서유럽', bias: 'wide', priceSensitivity: 0.75, prestige: 1.15,
      ...
      hub: 'london', startFleet: { 'b747-400': 3, 'b767-300er': 3 },
      startSlots: { london: 28, paris: 8, frankfurt: 6, newyork: 6, rome: 5 }, },
    { id: 'meridian', enginePref: 'CFM', name: '아비앙카', home: '남미', bias: 'narrow', priceSensitivity: 1.3, prestige: 0.6,
      ...
      hub: 'lima', startFleet: { 'a320': 4, 'b737-400': 4 },
      startSlots: { lima: 20, saopaulo: 8, buenosaires: 6, miami: 5, mexicocity: 4 }, },
    { id: 'sahara', enginePref: 'GE', name: '에티오피아 항공', home: '아프리카', bias: 'regional', priceSensitivity: 1.25, prestige: 0.55,
      ...
      hub: 'nairobi', startFleet: { 'b737-400': 3, 'crj200': 3, 'atr42-500': 3 },
      startSlots: { nairobi: 18, johannesburg: 6, cairo: 5, lagos: 5, dubai: 4 }, },
    ...
    { id: 'lumen', enginePref: 'GE', name: 'KLM 시티호퍼', home: '서유럽', bias: 'regional', priceSensitivity: 1.1, prestige: 0.75,
      ...
      hub: 'amsterdam', startFleet: { 'rj100': 5, 'erj145': 4 },
      startSlots: { amsterdam: 22, london: 6, paris: 5, frankfurt: 5, stockholm: 4 }, },
    { id: 'vertex', enginePref: 'CFM', name: '라이언에어', home: '서유럽', bias: 'narrow', priceSensitivity: 1.4, prestige: 0.45,
      ...
      hub: 'london', startFleet: { 'b737-400': 7, 'a320': 4 },
      startSlots: { london: 20, paris: 6, madrid: 6, rome: 6, frankfurt: 5 }, },
  ];
